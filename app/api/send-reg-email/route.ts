...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const responseRegister = await resend.emails.send({
      ...
      to: process.env.REG_EMAIL_RECEIVER!,
